...
module.exports = {
	...
	admin: {
		...
		validEmails: ["el-hecto_22@hotmail.com"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [235404759328446]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: '//ZjQvnRfEpWHBB5sSBFUSWLk7/BMUewJYo7/NotW2g=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: '614ynh3qB8J++R8akE8NmqkZ+1YHJdoaYd1Wdp5DuVTjE6BYcTPrS+AJcPzizkgzMsfxYEZ0kDDpYN7VZGcTTA==',
		secret: 'iorHqjfRbSuXQvqMVRIo5/IGHvO4XMqk', // should be a large unguessable string
	...
	cookieSecret: 'Kd2m5gFkOB3/6GCVmBHRjfQF+nKVzSOG',
